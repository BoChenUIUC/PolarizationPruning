...
def line_plot(XX,YY,label,color,path,xlabel,ylabel,lbsize=labelsize_b,legloc='best',linestyles=linestyles,
				...
				use_comm_annot=False,use_connarrow=False,lgsize=None,oval=False,scatter_soft_annot=False):
	if lgsize is None:
		lgsize = lbsize
	if get_ax==1:
		ax = plt.subplot(211)
...
def analyze_all_recorded_traces():
    ...
    # line_plot(x, all_latency_list[[1],],labels,colors,'/home/bo/Dropbox/Research/NSDI24fFaultless/images/latency_all.eps','Batch Size','Latency',
...
# cifar breakdown
latency_types = ['MAP','DCN','RED','INF','WAN']	
labels = ['NR', 'TR','Ours',]
