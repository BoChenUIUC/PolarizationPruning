...
def line_plot(XX,YY,label,color,path,xlabel,ylabel,lbsize=labelsize_b,legloc='best',linestyles=linestyles,
				...
				rotation=None,use_resnet56_2arrow=False,use_resnet56_3arrow=False,use_resnet56_4arrow=False,use_resnet50arrow=False,):
	if get_ax==1:
		ax = plt.subplot(211)
	elif get_ax==2:
		ax = plt.subplot(212)
...
x = [[5*i for i in range(21)]for _ in range(3)]
y = [[0.9412,0.8952076677316294, 0.8559744408945689, 0.8006349840255591, 0.7715575079872204, 0.7276817092651757, 0.6874061501597443, 0.6470806709265176, 0.6192971246006389, 0.5675778753993611, 0.5140934504792333, 0.47187699680511175, 0.4359105431309905, 0.40188298722044735, 0.3593330670926517, 0.31200279552715654, 0.26528354632587864, 0.23460263578274768, 0.18602236421725243, 0.14210063897763578, 0.09999999999999999], 
[0.9412,0.9391613418530351, 0.9333845846645368, 0.9183186900958468, 0.9056349840255592, 0.8840615015974441, 0.8652715654952077, 0.8386301916932906, 0.8100559105431311, 0.7772523961661342, 0.7156030351437698, 0.6799161341853036, 0.6352196485623003, 0.5893111022364217, 0.5338558306709265, 0.4680531150159745, 0.39878793929712464, 0.34153554313099044, 0.2599620607028755, 0.18303115015974442, 0.09999999999999999], 
[0.9412,0.899095447284345, 0.8933985623003193, 0.8794508785942492, 0.8672763578274761, 0.8465115814696486, 0.828460463258786, 0.8033765974440893, 0.7764197284345047, 0.7447843450479233, 0.6861002396166136, 0.6525898562300319, 0.609620607028754, 0.5653594249201278, 0.5126297923322685, 0.44955271565495203, 0.3840115814696486, 0.3304632587859425, 0.252723642172524, 0.17854832268370607, 0.09999999999999999]]
yerr = [[0,0.011260182146259791, 0.014413311653035226, 0.017523936633001044, 0.009319105501464493, 0.01319157239497189, 0.011294968490544358, 0.016082238619323782, 0.01840131523221126, 0.016516378997076073, 0.02778679090885529, 0.034062700268130415, 0.015022452569885691, 0.025407381590878738, 0.028199650977046953, 0.013870876668412729, 0.015699293234302938, 0.018281963891190103, 0.012310348049690256, 0.010905767148703317, 0.0], 
[0,0.0017894716355381394, 0.003162064943731756, 0.005419339373867469, 0.006055713071634825, 0.010269434158207238, 0.012588103321658833, 0.01419108531303968, 0.01438928909632326, 0.01522915177096201, 0.024226380198023992, 0.021811505048784142, 0.024507593426803382, 0.019478788423349092, 0.032334044198321976, 0.019286510865206916, 0.02577542687886167, 0.021139513690353724, 0.021741935246511076, 0.010289076958136276, 0.0], 
[0,0.0016209839569251336, 0.0033152040683001698, 0.005159208473857998, 0.006008895881228081, 0.009782645782220342, 0.01205045679733921, 0.013904926848480242, 0.014033100958536509, 0.014416755351008087, 0.023347434802545412, 0.02109412681060582, 0.022731767962123558, 0.01892629314907507, 0.03145490124779113, 0.017745379530370375, 0.02449504368343699, 0.019703788883335432, 0.021046551702021542, 0.009599907383162791, 0.0]]
line_plot(x, y,['Standalone','Replication','Partition'],colors,
