...
methods_tmp = ['Replication','Ours','Standalone']
line_plot(x,y,methods_tmp,colors_tmp,
		'/home/bo/Dropbox/Research/SIGCOMM23/images/FCC_ea.eps',
		'Deadline (s)','Delivered Accuracy (%)',xticks=[0.5,1,1.5,2.0],yticks=[0,25,50,75,100],lbsize=16,linewidth=4,markersize=0,linestyles=linestyles_tmp,
		yerr=yerr)	
...
x = [[0.05*i for i in range(1,11)] for _ in range(3)]
y = np.array(y_ea_loss1)[:,:10]*100;yerr = np.array(yerr_ea_loss1)[:,:10]*100
line_plot(x, y,methods_tmp,colors_tmp,
