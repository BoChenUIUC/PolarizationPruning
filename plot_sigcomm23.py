...
# multi-node analysis
methods = ['NS (base)','FS (base)','NS (ours)','FS (ours)']
...
line_plot(x,y1,methods_tmp,colors,
		...
		'FLOPS (%)','Reliability (%)',lbsize=24,linewidth=0,markersize=16,linestyles=linestyles,lgsize=20,bbox_to_anchor=(.5,.5),ncol=1)	
...
line_plot(x,y2,methods_tmp,colors,
		...
		'FLOPS (%)','Reliability (%)',lbsize=24,linewidth=0,markersize=16,linestyles=linestyles,lgsize=20)	
...
y = y[[5,4,3,0],-n_soft:];yerr = yerr[[5,4,3,0],-n_soft:]
line_plot(x, y,methods_tmp,colors_tmp,
...
line_plot(x, y,methods_tmp,colors_tmp,
		...
		'Failure Rate (%)','Effective Accuracy (%)',lbsize=24,linewidth=8,markersize=0,linestyles=linestyles_tmp,
		yerr=yerr)
...
line_plot(x,y,methods_tmp,colors_tmp,
		...
		'Failure Rate (%)','Effective Accuracy (%)',lbsize=16,linewidth=4,markersize=0,linestyles=linestyles_tmp,yticks=[25,50,75,100],
		yerr=yerr)	
...
groupedbar(y,None,'Reliability (%)', 
	'/home/bo/Dropbox/Research/SIGCOMM23/images/re_vs_conv.eps',methods=['NS','FS'],envs=envs,
...
groupedbar(y,None,'Reliability (%)', 
	'/home/bo/Dropbox/Research/SIGCOMM23/images/re_vs_sr.eps',methods=['NS','FS'],envs=envs,
...
groupedbar(y,None,'Reliability (%)', 
	'/home/bo/Dropbox/Research/SIGCOMM23/images/re_vs_ratio.eps',methods=['NS','FS'],envs=envs,
