...
groupedbar(y,None,'Consistency (%)', 
	'/home/bo/Dropbox/Research/SIGCOMM23/images/re_vs_conv.eps',methods=['JT','FS'],envs=envs,labelsize=18,
	ncol=1,sep=1,bbox_to_anchor=(0.5, 1.2),width=0.4,xlabel='Bridge Size and FLOPS (%)',legloc='lower left')
exit(0)
...
groupedbar(y,None,'Consistency (%)', 
	'/home/bo/Dropbox/Research/SIGCOMM23/images/re_vs_sr.eps',methods=['JT','FS'],envs=envs,labelsize=18,
...
groupedbar(y,None,'Consistency (%)', 
	'/home/bo/Dropbox/Research/SIGCOMM23/images/re_vs_ratio.eps',methods=['JT','FS'],envs=envs,labelsize=18,
...
line_plot(x,y1,methods_tmp,colors,
		...
		'FLOPS (%)','Consistency (%)',lbsize=24,linewidth=0,markersize=16,linestyles=linestyles,
