		...
		if use_barlabel_x:
			if i in [2,3]:
				for k,xdx in enumerate(x_index):
					ax.text(xdx-0.07,data_mean[k,i]+3,f'{data_mean[k,i]:.4f}',fontsize = 18, rotation='vertical',fontweight='bold')
...
methods_tmp = ['Baseline','Model Split','Ours']
...
methods_tmp = [r'Rn.($\times$2)',r'Rn.($\times$3)',r'Rn.($\times$4)',r'Ours($\times$2)',r'Ours($\times$3)',r'Ours($\times$4)','Baseline']
colors_tmp = colors + ['k']
...
line_plot(x,y,methods_tmp,colors_tmp,
		...
		'Deadline (s)','Effective Accuracy (%)',lbsize=16,linewidth=4,markersize=0,linestyles=linestyles_tmp,yticks=[0,25,50,75,100],
		yerr=yerr)	
# hard
...
line_plot(x,y,methods_tmp,colors_tmp,
		...
		'Loss Rate (%)','Effective Accuracy (%)',lbsize=16,linewidth=4,markersize=0,linestyles=linestyles_tmp,yticks=[25,50,75,100],
		yerr=yerr)	
...
methods_tmp = ['Optimal','Baseline','Split','Ours']
line_plot(x,y,methods_tmp,colors_tmp,
		'/home/bo/Dropbox/Research/SIGCOMM23/images/FCC_ea.eps',
		'Deadline (s)','Effective Accuracy (%)',lbsize=16,linewidth=2,markersize=0,linestyles=linestyles_tmp,
		yerr=yerr)	
x = [[i for i in range(25-n_soft,25)] for _ in range(4)]
y = [[0.8107558399999999, 3.4284124799999995, 10.97999784, 22.371772479999997, 35.817034719999995, 47.429199200000006, 56.09132407999999, 61.88740640000001, 67.27851023999999, 71.94365447999999, 76.23281984, 79.45724304000001, 81.85791112, 83.90299856, 85.73109911999998, 86.74704312, 87.64639344, 88.44354976000001, 89.07711472000001, 89.50449128], 
[0.41977728000000003, 1.9812919999999998, 6.079268319999999, 12.804502079999997, 20.932458399999994, 28.72923216, 35.286073599999995, 40.218603519999995, 45.33132447999999, 50.32745216, 54.93519968, 58.817387839999995, 62.51038559999999, 65.44322504, 69.0442284,71.36990184000001, 73.37839136, 75.29088663999998, 77.12638655999999, 78.55790816], 
[0.95474816, 3.8219919199999994, 11.801555999999996, 23.66390816, 37.112172560000005, 48.49955096, 56.82649495999999, 62.52638352, 67.98188552, 72.68282959999999, 76.84380232, 79.98943072, 82.30130424000001, 84.30679407999999, 86.19409135999999, 87.16523839999999, 88.0103916, 88.89054368000001, 89.46871208, 89.91028792000002]]
y += [[0.9471483200000002, 3.79299192, 11.696955999999998, 23.46530792, 36.80457336, 48.09275183999999, 56.381695679999986, 62.050983759999994, 67.45308560000001, 72.11682952000001, 76.26260152, 79.36323096000001, 81.65410471999999, 83.64559424000001, 85.52449143999999, 86.48423863999999, 87.33139144, 88.20154368, 88.77351208000002, 89.20968816000001]]
...
yerr += [[0.10860877712579953, 0.21122995885499207, 0.3448847885867508, 0.6576314087628543, 0.6670531876863838, 0.6438935043991855, 0.8532396350509714, 0.7632676213175091, 0.6303666251034297, 0.5246677772810618, 0.3463953542105896, 0.27687641230430116, 0.33018231650528235, 0.28465512152836137, 0.25551330817238005, 0.20729978243817945, 0.1905787132205624, 0.1477298983957717, 0.1595860500535832, 0.14020321888404336]]
...
line_plot(x, y,methods_tmp,colors_tmp,
		...
		'Failure Rate (%)','Effective Accuracy (%)',lbsize=16,linewidth=2,markersize=0,linestyles=linestyles_tmp,yerr=yerr)
...
y_ea_loss2 += [[90.82399999999998, 90.55941440000001, 89.9766468, 88.83351008000001, 87.08980504000002, 85.03771928, 82.75404520000002, 79.71481056, 76.11161008, 72.69699752000001, 67.88966232, 63.34611295999999, 58.4087852, 52.14733008, 46.402846159999996, 39.86840504, 32.96018719999999, 25.1190176, 17.1334588, 8.846513439999999, 0.004999999999999998]]
...
yerr_ea_loss2 += [[1.4210854715202004e-14, 0.05725458942065873, 0.05858051152388438, 0.12228830059165358, 0.3205936940056188, 0.20458761075652918, 0.20734310688448881, 0.2934335101408421, 0.3356917965586321, 0.30995757129918805, 0.4467538844099554, 0.3787063651748843, 0.4328081161682255, 0.4636565730516945, 0.6998832518406075, 0.30120095595344537, 0.44759713993967504, 0.3355903251640005, 0.33785488848183365, 0.37633882742015073, 8.673617379884035e-19]]
x = [[0.05*i for i in range(n_hard)] for _ in range(4)]
y = np.array(y_ea_loss2);yerr = np.array(yerr_ea_loss2)
y = y[[2,1,3,0],:n_hard];yerr = yerr[[2,1,3,0],:n_hard]
line_plot(x, y,methods_tmp,colors_tmp,
		'/home/bo/Dropbox/Research/SIGCOMM23/images/FCC_loss_ea2.eps',
		'Failure Rate (%)','Effective Accuracy (%)',lbsize=16,linewidth=2,markersize=0,linestyles=linestyles_tmp,
		yerr=yerr)
...
# multi-node analysis
methods = ['JD (base)','FS (base)','JD (rn.)','FS (rn.)']
...
methods_tmp = ['Ours (w/ C+T)','w/o Transform','w/o Collaboration','Baseline (w/o C+T)']
...
line_plot(x, y,['Base','St.',r'Rn.($\times$2)',r'Rn.($\times$3)',r'Rn.($\times$4)'],colors,
